...
void Graphics::clearScreen()
{
	...
	FillConsoleOutputAttribute(_console, csbi.wAttributes, size, { 0, 0 }, &dWord);
	FillConsoleOutputCharacter(_console, L' ', size, { 0, 0 }, &dWord);
}

void Graphics::moveTo(int x, int y)
{
	SetConsoleCursorPosition(_console, { (SHORT)x,(SHORT)y });
}
